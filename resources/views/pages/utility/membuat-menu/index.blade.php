                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="search" data-kt-datatable-table-filter="search" id="seacrh"
                                            class="form-control form-control-solid" placeholder="Cari Menu" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_1" name="check_1"
                                                    type="checkbox" data-checkbox="check_1" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                data-kt-select2="true" data-placeholder="Pilih route"
                                                data-allow-clear="true" data-kt-datatable-table-filter="nama-route"
                                                data-hide-search="false" id="tipe_menu" name="tipe_menu">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_2" type="checkbox"
                                                    data-checkbox="check_2" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                data-kt-select2="true" data-placeholder="Pilih menu" data-allow-clear="true"
...
@section('script')
    <script>
        ...
        $(function() {
            ...
            selectSide('tipe_menu', false, "{{ url('api/utility/menu/select-tipemenu') }}", function(d) {
                return {
                    id: d.wmt_kode,
                    text: d.wmt_nama
                }
                ...
                selectSide('key', false, "{{ url('api/utility/menu/select-menu') }}" + "?tipe=" + data,
                    function(d) {
                        return {
                ...
                [ //fillable body table name, sesuaikan dengan field yang terdapat pada tr thead
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if (route !== "" && route !== null) {
                                return `<div class="badge badge-light-success fw-bolder">` + row.wmn_url_n +
                                    `</div>`;
                            } else {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if (url !== "" && url !== null) {
                                return `<div class="badge badge-light fw-bolder">` + row.wmn_url_o_n +
                                    `</div>`;
                            } else {
