    ...
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            <div class="modal-header" id="modalMenu_header">
                ...
                <button type="button" class="btn btn-icon btn-sm btn-active-light-primary" onclick="closeBtnModal()"><i
            ...
            <form id="formMenu" name="formMenu" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" data-control="select2" name="wmn_tipe"
                                        id="wmn_tipe" data-dropdown-parent="#modalMenu"
                                        data-placeholder="Pilih tipe menu" data-allow-clear="true">
                                        <option></option>
                                        {{-- {{ optSql('SELECT wmt_kode kode, wmt_nama nama FROM web_conf.web_menu_tipe WHERE 1=1 ORDER BY 1', 'kode', 'nama') }} --}}
                                    </select>
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="input-group input-group-solid">
                                    <input type="text" class="form-control form-control-solid" name="wmn_kode"
                                        id="wmn_kode" placeholder="PK Menu" />
                            ...
                            <div class="col-md-6 mb-5">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" name="wmn_key" id="wmn_key"
                                        data-dropdown-parent="#modalMenu" data-placeholder="ex. MAIN"
                                        data-allow-clear="true">
                                        <option></option>
                                        {{-- {{ optSql('SELECT wmn_tipe kode, wmn_descp nama FROM web_conf.web_menu WHERE 1=1 ORDER BY 1', 'kode', 'nama') }} --}}
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid">
                                        <input type="text" class="form-control form-control-solid" name="wmn_icon"
                                            id="wmn_icon" placeholder="ex. fa-solid fa-house" />
                                        <div class="input-group-append">
                                            <a href="https://fontawesome.com/search?s=solid&f=classic&o=r"
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="wmn_descp"
                                        id="wmn_descp" placeholder="ex. Sekper" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="wmn_url_n"
                                        id="wmn_url_n" placeholder="ex. utility.menu.create" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea class="form-control form-control-solid" rows="3" name="wmn_urlkode" id="wmn_urlkode"
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="wmn_info"
                                        id="wmn_info" placeholder="Tips Menu" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-5">
                                <div class="mb-5">
                                    <label class="required form-label">URL Menu</label>
                                    <input type="text" class="form-control form-control-solid" name="wmn_url_o_n"
                                        id="wmn_url_o_n" placeholder="ex. utility/menu" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="wmn_urut"
                                        id="wmn_urut" placeholder="Urutan Menu" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" name="wmn_mrkn_kode"
                                        id="wmn_mrkn_kode" data-dropdown-parent="#modalMenu"
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" name="wmn_mpol_kode"
                                        id="wmn_mpol_kode" data-dropdown-parent="#modalMenu"
                                        data-placeholder="pilih Nomor Polis" data-allow-clear="true">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-danger btn-sm" onclick="closeBtnModal()"><i
