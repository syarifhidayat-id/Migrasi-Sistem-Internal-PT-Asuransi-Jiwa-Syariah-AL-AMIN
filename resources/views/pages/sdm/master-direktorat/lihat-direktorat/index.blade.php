    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-datatable-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Cari direktorat" />
            </div>
        </div>
    ...
    <div class="card-body py-10">
        <div class="table-responsive">
            <table class="table table-rounded table-striped border align-middle gy-5 gs-5" id="kt_table_datatable">
                ...
                <tbody>
                    @foreach ($caridir as $key=>$data)
                        <tr>
                            <td class="text-center">{{ ++$key }}.</td>
                            <td>{{ $data->sdir_kode }}</td>
                            <td>{{ $data->sdir_ket }}</td>
                            <td>{{ $data->sdir_kode_surat }}</td>
