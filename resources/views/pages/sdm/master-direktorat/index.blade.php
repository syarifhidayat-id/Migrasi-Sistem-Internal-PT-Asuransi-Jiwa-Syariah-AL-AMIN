    ...
    <div class="card-toolbar justify-content-end">
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-datatable-table-toolbar="base">
                <a type="button" href="{{ route('sdm.pegawai.lihat-direktorat.index') }}" class="btn btn-success btn-sm" id="btn_tutup"><i
            ...
            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">
                ...
                <div class="col">
                    <div class="fv-row mb-7">
                        <label class="form-label fs-6 fw-bold">Kode Direktorat :</label>
                        ...
                        <input type="text" class="form-control form-control-solid" name="sdir_kode" id="sdir_kode"/>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control form-control-solid" name="sdir_ket" id="sdir_ket"/>
                    </div>
                </div>

                <div class="col">
                    <div class="fv-row mb-7">
                        <label class="form-label fs-6 fw-bold">Kode Surat :</label>
                        <input type="text" class="form-control form-control-solid" name="sdir_kode_surat" id="sdir_kode_surat"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#frxx').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('sdm.pegawai.master-direktorat.store') }}",
