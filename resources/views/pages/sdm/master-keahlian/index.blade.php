    ...
    <div class="card-toolbar justify-content-end">
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-datatable-table-toolbar="base">
                <a type="button" target="newtab" href="{{ route('sdm.pegawai.lihat-keahlian.index') }}" class="btn btn-success btn-sm" id="btn_tutup"><i
                    class="fa-solid fa-eye"></i> Lihat Keahlian
                </a>
            ...
            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">
                ...
                <div class="col">
                    <div class="fv-row mb-7">
                        <label class="form-label fs-6 fw-bold">Kode Keahlian Khusus :</label>
                        ...
                        <input type="text" class="form-control form-control-solid" name="skah_kode" id="skah_kode"/>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control form-control-solid" name="skah_ket" id="skah_ket"/>
                    </div>
                </div>

                <div class="col">
                    <div class="fv-row mb-7">
                        <label class="form-label fs-6 fw-bold">Tunjangan Keahlian :</label>
                        <input type="number" class="form-control form-control-solid" name="skah_tunjangan" id="skah_tunjangan"/>
                    </div>
                </div>
