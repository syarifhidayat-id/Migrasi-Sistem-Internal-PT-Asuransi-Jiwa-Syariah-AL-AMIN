                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_nomor" name="check_nomor"
                                                    type="checkbox" data-checkbox="check_nomor" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                data-placeholder="Pilih nomor undand-undang" data-allow-clear="true"
                                                data-kt-datatable-table-filter="check_nomor_uu" data-hide-search="false"
                                                id="check_nomor_uu">
                                                <option></option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                ...
                                                data-kt-datatable-table-filter="check_uu_tentang" data-hide-search="false"
                                                id="check_uu_tentang">
                                                <option></option>
                                            </select>
                                        </div>
                ...
                <table class="table table-rounded table-striped border align-middle gy-5 gs-5" id="serverSide_uu">
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200 text-center align-middle">
                            <th>No.</th>
                            <th>Nomor</th>
                            <th class="min-w-50px">Tentang</th>
                            <th>User Input</th>
                            <th>Tanggal Input</th>
                            <th>Dokumen</th>
                        </tr>
...
@section('script')
    <script type="text/javascript">
        $(function() {
            ...
            selectSide('check_nomor_uu', false, '{{ url('api/legal/uu_asuransi/selectNomor') }}', function(d) {
                return {
                    id: d.mua_nomor,
                    text: d.mua_nomor
                }
            ...
            changeSelect('check_nomor_uu', 'key', '{{ url('api/legal/pks/getId') }}', function(d) {
                return {
                    id: d.mua_nomor,
                    text: d.mua_nomor
                }
            ...
            selectSide('check_uu_tentang', false, '{{ url('api/legal/uu_asuransi/selectTentang') }}', function(d) {
                return {
                    id: d.mua_tentang,
                    text: d.mua_tentang
                }
            ...
            changeSelect('check_uu_tentang', 'key', '{{ url('api/legal/pks/getTentang') }}', function(d) {
                return {
                    id: d.mua_tentang,
                    text: d.mua_tentang
                }
            ...
            tombol('click', 'bmoViewPdf', function() {
                ...
                var loc = '{{ url("storage/legal/uu_asuransi") }}'+ '/' + kode;
                openModal('modalView');
                $('#view_pdf').attr('src', loc);
            });
