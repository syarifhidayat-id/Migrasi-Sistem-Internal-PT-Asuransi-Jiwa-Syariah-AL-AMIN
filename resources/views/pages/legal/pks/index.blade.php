        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                            ...
                            <div class="row mb-10">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_instansi" name="check_instansi"
                                                    type="checkbox" data-checkbox="check_instansi" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                data-placeholder="Pilih instansi" data-allow-clear="true"
                                                data-kt-datatable-table-filter="check_pks_instansi" data-hide-search="false"
                                                id="check_pks_instansi">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_no_pks" name="check_no_pks"
                                                    type="checkbox" data-checkbox="check_no_pks" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                data-placeholder="Pilih nomor pks" data-allow-clear="true"
                                                data-kt-datatable-table-filter="check_pks_no" data-hide-search="false"
                                                id="check_pks_no">
                                                <option></option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_pic" name="check_pic"
                                                    type="checkbox" data-checkbox="check_pic" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                data-placeholder="Pilih PIC" data-allow-clear="true"
                                                data-kt-datatable-table-filter="check_pic_pks" data-hide-search="false"
                                                id="check_pic_pks">
                                                <option></option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-10">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <label class="form-check form-switch form-check-custom form-check-solid me-5">
                                                <input class="form-check-input" id="check_status" name="check_status"
                                                    type="checkbox" data-checkbox="check_status" />
                                            </label>
                                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                                data-placeholder="Pilih status berlaku" data-allow-clear="true"
                                                data-kt-datatable-table-filter="check_status_berlaku"
                                                data-hide-search="false" id="check_status_berlaku">
                                                <option></option>
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="d-flex justify-content-end" data-kt-datatable-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-light-primary btn-sm me-3" data-bs-toggle="tooltip"
                        data-bs-trigger="hover" data-bs-placement="top" title="Tambah Addendum"
                        onclick="tombolAct(2)">Addendum</button>
                    <button type="button" class="btn btn-light-primary btn-sm" data-bs-toggle="tooltip"
                        data-bs-trigger="hover" data-bs-placement="top" title="Batal"
                        onclick="tombolAct(3)">Batal</button>
                </div>
...
@section('script')
    <script type="text/javascript">
        $(function() {
            ...
            //SELECT FILTER
            selectSide('check_pks_instansi', false, '{{ url('api/legal/pks/select-instansi') }}', function(d) {
                return {
                    id: d.mpks_instansi,
            ...
            selectSide('check_pks_no', false, '{{ url('api/legal/pks/select-no-pks') }}', function(d) {
                return {
                    id: d.mpks_nomor,
                    text: d.mpks_nomor
                }
            ...
            selectSide('check_pic_pks', false, '{{ url('api/legal/pks/selectPic') }}', function(d) {
                return {
                    id: d.mpks_pic,
                    text: d.mpks_pic
                }
            ...
            selectSide('check_ins_user', false, '{{ url('api/legal/pks/selectInsUser') }}', function(d) {
                return {
                    id: d.mpks_ins_user,
            ...
            //SELECT FORM
            selectSide('mpks_mrkn_kode_test', false, '{{ url('api/legal/pks/polis') }}', function(data) {
                return {
            ...
            selectSide('cari_pk', false, '{{ url('api/legal/get_select_pks') }}', function(d) {
                    return {
                ...
                function(res) {
                    ...
                    $.get(key, function(a) {
                        ...
                        if (a.mpks_mrkn_kode !== "") {
                            var mrkn = "{{ url('api/legal/pks/get_edit_polis') }}" + "/" + a
                                .mpks_mrkn_kode;
                            $.get(mrkn, function(b) {
            ...
            serverSide( //datatable serverside
                ...
                [ //fillable body table name, sesuaikan dengan field yang terdapat pada tr thead
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                        <button type="button" data-resouce="` + row.mpks_pk + `" onclick="jenisFile('` + row
                                .mpks_dokumen + `')" class="btn btn-light-primary" target="blank"> ` + row
                                .kode_rekanan + ` </button>`
                        }
                    },
                    {
            ...
            tombol('click', 'bmoDetail', function() {
                var kode = $(this).attr('data-resouce');
                lodJson("GET", "{{ url('api/legal/pks/lihat/pks') }}" + "/" + kode, function(data) {
                    openModal('modalView');
                    titleAction('tModView', 'Rincian PKS');
                    jsonForm('frxx1', data);
                });
            });
