    ...
    <div class="card mb-5 mb-xxl-10">
        ...
        <form id="frxx_mstpolis" name="frxx_mstpolis" class="form-mixs" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="input-group input-group-solid">
                        <button type="button" id="btnBru" class="btn btn-light-primary active" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Polis Baru"
                            onclick="cekForm(0)">Baru</button>
                        <button type="button" id="btnEdt" class="btn btn-light-primary" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Polis Edit"
                            onclick="cekForm(1)">Edit</button>
                        <button type="button" id="btnEds" class="btn btn-light-primary" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Polis Endors"
                            onclick="cekForm(2)">Endors</button>
                        <button type="button" id="btnEdsBr" class="btn btn-light-primary" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Polis Endors Baru"
                            onclick="cekForm(4)">Endors Baru</button>
                        <button type="button" id="btnBtl" class="btn btn-light-primary" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Polis Batal"
                            onclick="cekForm(3)">Batal</button>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="mpol_mrkn_nama" id="mpol_mrkn_nama"
                                data-options="prompt:'Pilih pemegang polis'" style="width: 100%; height: 38px;" />
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="mpol_msoc_kode" id="mpol_msoc_kode"
                                data-options="prompt:'Pilih kode soc'" style="width: 100%; height: 38px;" />
                    ...
                    <div class="col-md-12 bg-light-warning hoverable" id="polisOld">
                        <div class="mb-5 my-3">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_oldpolis" id="e_oldpolis"
                                data-options="prompt:'Pilih pemegang polis lama'" style="width: 100%; height: 38px;" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="mpol_mspaj_nama" id="mpol_mspaj_nama"
                                data-options="prompt:'Pilih nomor spaj'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mspaj_nomor"
                                id="mpol_mspaj_nomor" placeholder="mpol_mspaj_nomor" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_nasabah" id="e_nasabah"
                                data-options="prompt:'Pilih nasabah bank/peserta'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mjns_mpid_kode"
                                id="mpol_mjns_mpid_kode" placeholder="mpol_mjns_mpid_kode" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mjns_kode"
                                id="mpol_mjns_kode" placeholder="mpol_mjns_kode" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="mpol_mssp_nama" id="mpol_mssp_nama"
                                data-options="prompt:'Pilih segmen pasar'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mssp_kode"
                                id="mpol_mssp_kode" placeholder="mpol_mssp_kode" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jenis_bayar" id="mpol_jenis_bayar"
                                data-options="prompt:'Pilih kontribusi'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mekanisme" id="mpol_mekanisme"
                                data-options="prompt:'Pilih mekanisme'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mft_kode" id="mpol_mft_kode"
                                data-options="prompt:'Pilih manfaat asuransi', onSelect: function(rec){  }"
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mekanisme2" id="mpol_mekanisme2"
                                data-options="prompt:'Pilih penutupan'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_manfaat" id="e_manfaat"
                                data-options="prompt:'Pilih jaminan asuransi'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mjm_kode"
                                id="mpol_mjm_kode" placeholder="mpol_mjm_kode" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jns_perusahaan" id="mpol_jns_perusahaan"
                                data-options="prompt:'Pilih jenis pekerjaan'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_jenisprod" id="e_jenisprod"
                                data-options="prompt:'Pilih produk induk'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mpid_kode"
                                id="mpol_mpid_kode" placeholder="mpol_mpid_kode" />
                            <input type="text" class="form-control form-control-solid" name="endors" id="endors"
                                placeholder="endors" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_pras" id="e_pras"
                                data-options="prompt:'Pilih program asuransi'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mpras_kode"
                                id="mpol_mpras_kode" placeholder="mpol_mpras_kode" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mslr_kode" id="mpol_mslr_kode"
                                data-options="prompt:'Pilih saluran distribusi'" style="width: 100%; height: 38px;">
                            ...
                            <input type="text" class="form-control form-control-solid" name="e_bersih" id="e_bersih"
                                placeholder="e_bersih" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_cabalamin" id="e_cabalamin"
                                data-options="prompt:'Pilih cabang'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mlok_kode"
                                id="mpol_mlok_kode" placeholder="mpol_mlok_kode" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="easyui-combogrid" name="e_marketing" id="e_marketing"
                                data-options="prompt:'Pilih marketing'" style="width: 100%; height: 38px;" />
                            <input type="text" class="form-control form-control-solid" name="mpol_mkar_kode_mkr"
                                id="mpol_mkar_kode_mkr" placeholder="mpol_mkar_kode_mkr" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="e_pinca" id="e_pinca"
                                placeholder="Pimpinan cabang" />
                            <input type="text" class="form-control form-control-solid" name="msoc_mkar_kode_pim"
                                id="msoc_mkar_kode_pim" placeholder="msoc_mkar_kode_pim" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mpojk_kode" id="mpol_mpojk_kode"
                                data-options="prompt:'Pilih produk induk', onSelect: function(rec) { hidePesan('mpol_mpojk_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mja_kode" id="mpol_mja_kode"
                                data-options="prompt:'Pilih jenis asuransi', onSelect: function(rec) { hidePesan('mpol_mja_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mgpp_kode" id="mpol_mgpp_kode"
                                data-options="prompt:'Pilih produk segmen', onSelect: function(rec) { hidePesan('mpol_mgpp_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mgp_kode" id="mpol_mgp_kode"
                                data-options="prompt:'Pilih kelompok produk', onSelect: function(rec) { hidePesan('mpol_mgp_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mgs_kode" id="mpol_mgs_kode"
                                data-options="prompt:'Pilih rekan segmen', onSelect: function(rec) { hidePesan('mpol_mgs_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mlu_kode" id="mpol_mlu_kode"
                                data-options="prompt:'Pilih lini usaha', onSelect: function(rec) { hidePesan('mpol_mlu_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mgol_kode" id="mpol_mgol_kode"
                                data-options="prompt:'Pilih golongan', onSelect: function(rec) { hidePesan('mpol_mgol_kode') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_aktif" id="mpol_aktif"
                                data-options="prompt:'Pilih status', onSelect: function(rec){  }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_online" id="mpol_online"
                                data-options="prompt:'Pilih online cabang'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_online_rekan" id="mpol_online_rekan"
                                data-options="prompt:'Pilih online rekan', onSelect: function(rec) { hidePesan('mpol_online_rekan') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="date" class="form-control form-control-solid dateflatpickr"
                                name="mpol_tgl_terbit" id="mpol_tgl_terbit" placeholder="Pilih tanggal" />
                    ...
                    <div class="col-md-2">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_openpolis" id="mpol_openpolis"
                                data-options="prompt:'Pilih open polis', onSelect: function(rec){ cekopenpolis(); }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <div class="input-group">
                                <input type="date" class="form-control form-control-solid dateflatpickr"
                                    name="mpol_tgl_awal_polis" id="mpol_tgl_awal_polis" placeholder="Pilih tanggal" />
                                <span class="text-danger error-text mpol_tgl_awal_polis_err"></span>
                                <span class="input-group-text">s/d</span>
                                <input type="date" class="form-control form-control-solid dateflatpickr"
                                    name="mpol_tgl_ahir_polis" id="mpol_tgl_ahir_polis" placeholder="Pilih tanggal" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_lapor_data"
                                    id="mpol_lapor_data" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_byr_premi"
                                    id="mpol_byr_premi" />
                                <span class="input-group-text">Hari Dari Tanggal Tagihan</span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_max_pst"
                                    id="mpol_max_pst" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_aprove_fc" id="mpol_aprove_fc"
                                data-options="prompt:'Pilih approval'" style="width: 100%; height: 38px;">
                                <option value="0">NO</option>
                                <option value="1">YES</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jenis_cetak" id="mpol_jenis_cetak"
                                data-options="prompt:'Pilih cetak peserta pengajuan', onSelect: function(rec) { hidePesan('mpol_jenis_cetak') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_cetak_lunas" id="mpol_cetak_lunas"
                                data-options="prompt:'Pilih cetak peserta lunas', onSelect: function(rec) { hidePesan('mpol_cetak_lunas') }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_status_polis" id="mpol_status_polis"
                                data-options="prompt:'Pilih status'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_produkbank"
                                id="mpol_produkbank" placeholder="ex. Joni Alba" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_host2host" id="mpol_host2host"
                                data-options="prompt:'Pilih status', onSelect: function(rec) { hidePesan('mpol_host2host') }"
                                style="width: 100%; height: 38px;">
                                <option selected value="0">-</option>
                                <option value="1">POLIS MIGRASI LAPSE</option>
                                <option value="2">POLIS MIGRASI INFORCE</option>
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_ins_soc" id="mpol_ins_soc"
                                data-options="prompt:'Pilih endors baru'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_pemgroupusaha" id="mpol_pemgroupusaha"
                                data-options="prompt:'Pilih pemasaran group usaha', onSelect: function(rec) { hidePesan('mpol_pemgroupusaha') }"
                                style="width: 100%; height: 38px;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_max_up"
                                id="mpol_max_up" placeholder="max manfaat up" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                name="mpol_standar_perlindungan" id="mpol_standar_perlindungan"
                                placeholder="Nilai perlindungan" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_standar_premi"
                                id="mpol_standar_premi" placeholder="Nilai kontribusi statndar" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_usia_min"
                                    id="mpol_usia_min" placeholder="Min usia masuk" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_usia_max"
                                    id="mpol_usia_max" placeholder="Max usia masuk" />
                                <span class="input-group-text">Tahun</span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_jatuh_tempo"
                                    id="mpol_jatuh_tempo" placeholder="Usia jatuh tempo" />
                                <span class="input-group-text">Tahun</span>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_tenor_max"
                                    id="mpol_tenor_max" placeholder="Max jangka waktu" />
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid">
                                <input type="text" class="form-control form-control-solid" name="mpol_max_bayar_klaim"
                                    id="mpol_max_bayar_klaim" placeholder="Pembayaran klaim" />
                                <span class="input-group-text">Hari</span>
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid flex-nowrap">
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="easyui-combobox" name="mpol_mut_kode" id="mpol_mut_kode"
                                        data-options="prompt:'Pilih up tambahan'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid flex-nowrap">
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="easyui-combobox" name="mpol_mujhrf_kode" id="mpol_mujhrf_kode"
                                        data-options="prompt:'Pilih ujrah referal'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_lapor_stnc" id="mpol_lapor_stnc"
                                data-options="prompt:'Pilih stnc pelaporan'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-solid flex-nowrap">
                                <div class="overflow-hidden flex-grow-1">
                                    <select class="easyui-combobox" name="mpol_ujroh_treaty" id="mpol_ujroh_treaty"
                                        data-options="prompt:'Pilih ujrah treaty'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_klaim_doc" id="mpol_klaim_doc"
                                data-options="prompt:'Pilih qty dok. klaim'" style="width: 100%; height: 38px;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_penerima_manfaat" id="mpol_penerima_manfaat"
                                data-options="prompt:'Pilih penerima manfaat'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mnfa_kode" id="mpol_mnfa_kode"
                                data-options="prompt:'Pilih manfaat jiwa'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_mmft_kode_gu" id="mpol_mmft_kode_gu"
                                data-options="prompt:'Pilih manfaat tambahan gu'" style="width: 100%; height: 38px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_wp_swasta"
                                                id="mpol_mmft_kode_wp_swasta"
                                                data-options="prompt:'Pilih manfaat tambahan wp'"
                                                style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_wp_pns"
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_wp_pensiun"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_phk_swasta"
                                                id="mpol_mmft_kode_phk_swasta"
                                                data-options="prompt:'Pilih manfaat tambahan phk'"
                                                style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_phk_pns"
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmft_kode_phk_pensiun"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <select class="easyui-combobox" name="mpol_mmft_kode_fire" id="mpol_mmft_kode_fire"
                                        data-options="prompt:'Pilih manfaat tambahan Fire'"
                                        style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <select class="easyui-combobox" name="mpol_mmft_kode_tlo" id="mpol_mmft_kode_tlo"
                                        data-options="prompt:'Pilih manfaat tambahan tlo'"
                                        style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jl" id="mpol_jl"
                                data-options="prompt:'Pilih manfaat tambahan join life', onSelect: function(rec) { jointlife(); }"
                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jl_pst" id="mpol_jl_pst"
                                data-options="prompt:'Pilih manfaat j.life peserta'" style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_jl_pasangan" id="mpol_jl_pasangan"
                                data-options="prompt:'Pilih manfaat j.life pasangan'" style="width: 100%; height: 38px;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="easyui-combobox" name="mpol_pajakfee" id="mpol_pajakfee"
                                data-options="prompt:'Penanggung jawab fee'" style="width: 100%; height: 38px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_handlingfee" id="mpol_handlingfee"
                                                data-options="prompt:'Fee ppn'" style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_pajakfee_persen"
                                                id="mpol_pajakfee_persen" data-options="prompt:'Fee pph 23'"
                                                style="width: 100%; height: 38px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mujh_persen" id="mpol_mujh_persen"
                                                data-options="prompt:'Ujrah'" style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mmfe_persen" id="mpol_mmfe_persen"
                                                data-options="prompt:'Managemen fee'" style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_overreding" id="mpol_overreding"
                                                data-options="prompt:'Overreding'" style="width: 100%; height: 38px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mkom_persen" id="mpol_mkom_persen"
                                                data-options="prompt:'Komisi tidak potong'"
                                                style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_referal" id="mpol_referal"
                                                data-options="prompt:'Referal'" style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_maintenance"
                                                id="mpol_maintenance" data-options="prompt:'Maintenance'"
                                                style="width: 100%; height: 38px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mfee_persen"
                                                id="mpol_mfee_persen" data-options="prompt:'Feebase Tidak Potong'"
                                                style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mdr_kode" id="mpol_mdr_kode"
                                                data-options="prompt:'Feebase Potong'"
                                                style="width: 100%; height: 38px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-solid flex-nowrap">
                                        <div class="overflow-hidden flex-grow-1">
                                            <select class="easyui-combobox" name="mpol_mkomdisc_persen"
                                                id="mpol_mkomdisc_persen" data-options="prompt:'Komisi potong langsung'"
                                                style="width: 100%; height: 38px;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_surplus"
                                id="mpol_surplus" data-placeholder="Pilih berlaku surplus u/w"
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_va"
                                id="mpol_va" data-placeholder="Pilih vistual account" data-allow-clear="true">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="buka_paymod1[]" id="buka_paymod1" data-placeholder="Pilih VA"
                                            data-allow-clear="true" multiple="multiple"></select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <input type="text" class="form-control form-control-solid"
                                            name="mpol_va_via" id="mpol_va_via" placeholder="Virtuaal account" />
                    ...
                    <div class="col-md-2">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_payonline"
                                id="mpol_payonline" data-placeholder="Pilih" data-allow-clear="true">
                                <option selected disabled>Pilih</option>
                                <option value="0">NO</option>
                                <option value="1">YES</option>
                            </select>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="buka_paymod2[]" id="buka_paymod2" data-placeholder="Pilih VA"
                                            data-allow-clear="true" multiple="multiple"></select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <input type="text" class="form-control form-control-solid"
                                            name="mpol_playonline_via" id="mpol_playonline_via"
                                            placeholder="Pembayaran online" />
                    ...
                    <div class="col-md-2">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_agent"
                                id="mpol_agent" data-placeholder="Pilih" data-allow-clear="true">
                                <option selected disabled>Pilih</option>
                                <option value="0">NO</option>
                                <option value="1">YES</option>
                            </select>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="buka_paymod3[]" id="buka_paymod3" data-placeholder="Pilih VA"
                                            data-allow-clear="true" multiple="multiple"></select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <input type="text" class="form-control form-control-solid"
                                            name="mpol_agent_via" id="mpol_agent_via"
                                            placeholder="Pembayaran retail/agent" />
                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_msrf_kode"
                                id="mpol_msrf_kode" data-placeholder="Pilih keterangan" data-allow-clear="true">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2"
                                name="mpol_jenis_login" id="mpol_jenis_login" data-placeholder="Pilih jenis login"
                                data-allow-clear="true">
                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" name="mpol_acc_tek"
                                id="mpol_acc_tek" data-placeholder="Pilih persetujuan" data-allow-clear="true">
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_note"
                                id="mpol_note" placeholder="Makukkan catatan" />
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_no_endors"
                                id="mpol_no_endors" placeholder="Makukkan no surat endors" />
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_ket_endors"
                                id="mpol_ket_endors" placeholder="Makukkan keterangan endors" />
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="mpol_mprov_kode" id="mpol_mprov_kode"
                                            data-placeholder="Pilih berlaku" data-allow-clear="true">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="o_prov[]" id="o_prov" data-placeholder="Pilih provinsi"
                                            data-allow-clear="true" multiple="multiple"></select>
                                        <input type="text" class="form-control form-control-solid"
                                            name="mpol_mprov_berlaku" id="mpol_mprov_berlaku" placeholder="" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" name="mpol_nomor_cetak"
                                id="mpol_nomor_cetak" placeholder="Nomor Cetak" />
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="mpol_jns_tarif" id="mpol_jns_tarif" data-placeholder="Pilih">
                                            <option selected disabled>Pilih</option>
                                ...
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <div class="input-group input-group-solid flex-nowrap">
                                            <div class="overflow-hidden flex-grow-1">
                                                <input type="text" class="easyui-combogrid" name="e_tarif"
                                                    id="e_tarif" data-options="prompt:'Pilih jenis tarif'"
                                                    style="width: 100%; height: 38px;" />
                                                <input type="text" class="form-control form-control-solid"
                                                    name="mpol_mth_nomor" id="mpol_mth_nomor"
                                                    placeholder="mpol_mth_nomor" />
                                            </div>
                                            <button type="button" id="lihatTarif"
                                                class="btn btn-sm btn-light-primary"><i class="fa-solid fa-eye"></i>
                                                Lihat</button>
                                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        <select class="form-select form-select-solid" data-control="select2"
                                            name="mpol_tipe_uw" id="mpol_tipe_uw" data-placeholder="Pilih">
                                            <option selected disabled>Pilih</option>
                                ...
                                <div class="col-md-8">
                                    <div class="mb-5">
                                        <div class="input-group input-group-solid flex-nowrap">
                                            <div class="overflow-hidden flex-grow-1">
                                                <input type="text" class="easyui-combogrid" name="e_uw"
                                                    id="e_uw" data-options="prompt:'Pilih jenis underwriting'"
                                                    style="width: 100%; height: 38px;" />
                                                <input type="text" class="form-control form-control-solid"
                                                    name="mpol_mpuw_nomor" id="mpol_mpuw_nomor"
                                                    placeholder="mpol_mpuw_nomor" />
                                            </div>
                                            <button type="button" id="lihatUw"
                                                class="btn btn-sm btn-light-primary"><i class="fa-solid fa-eye"></i>
                                                Lihat</button>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group input-group-solid">
                                        <input type="file" class="form-control" name="mpol_dok" id="mpol_dok"
                                            accept="application/pdf" placeholder="pilih file" />
                                        <button type="button" id="lihatDocPolis"
                                            class="btn btn-sm btn-light-primary"><i class="fa-solid fa-eye"></i>
                                            Lihat</button>
                                    </div>
            ...
            <div class="card-footer text-center">
                <button type="submit" class="btn btn-primary btn-sm me-3" id="btn_simpan"><i
                        class="fa-solid fa-floppy-disk"></i> Simpan</button>
                <button type="button" class="btn btn-warning btn-sm" onclick="clear_f()"><i
                        class="fa-solid fa-trash"></i> Bersihkan</button>
            </div>
        </form>
    </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            cekForm(0);
            buka_paymod('buka_paymod1', 'mpol_va_via', '{{ url('tehnik/polis/entry-master-polis/lod_paymod') }}' +
                '?tipe=V');
            buka_paymod('buka_paymod2', 'mpol_playonline_via',
                '{{ url('tehnik/polis/entry-master-polis/lod_paymod') }}' + '?tipe=O');
            buka_paymod('buka_paymod3', 'mpol_agent_via',
                '{{ url('tehnik/polis/entry-master-polis/lod_paymod') }}' + '?tipe=A');
            buka_provinsi('{{ url('tehnik/polis/entry-master-polis/lod_provinsi') }}', 'polis', '&polis=' +
                getText('mpol_kode'));
        });
        ...
        $(function() {
            ...
            selectGrid('mpol_mrkn_nama', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_pmg_polis') }}',
                'nama', 'nama', [{
                        field: 'kode',
                        title: 'Kode',
                        align: 'left',
                ...
                function(i, row) {
                    ...
                    reSelGrid('mpol_msoc_kode', '{{ url('tehnik/polis/entry-master-polis/lod_soc') }}' +
                        '?pmgpolis=' + getText("mpol_mrkn_kode"));
                });

            selectGrid('mpol_msoc_kode', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_soc') }}',
                'msoc_kode', 'msoc_kode', [{
                        field: 'msoc_kode',
                        title: 'Kode SOC',
                        width: 130
                    ...
                    {
                        field: 'mpras_nama',
                        title: 'Program Asuransi',
                        width: 97
                    },
                    {
                        field: 'msoc_mrkn_nama',
                        title: 'Pmg Polis',
                        width: 200,
                        hidden: true
                    },
                ...
                function(i, row) {
                    ...
                    reSelGrid('e_tarif', '{{ url('tehnik/polis/entry-master-polis/lod_tarif_polis') }}' +
                        '?pmgpolis=' + getText("mpol_mrkn_kode") + "&msoc=" + getText("mpol_msoc_kode") +
                        "&mft=" + getText("mpol_mft_kode") + "&jnspro=" + getText("judul"));
                    reSelGrid('e_uw', '{{ url('tehnik/polis/entry-master-polis/lod_uw_polis') }}' +
                        '?pmgpolis=' + getText("mpol_mrkn_kode") + "&msoc=" + getText("mpol_msoc_kode") +
                        "&mft=" + getText("mpol_mft_kode") + "&jnspro=" + getText("judul"));

                    muncul4(row.mjm_bundling, row.mjns_wp_pens, row.mjns_phk_pens, row.mjm_jiwa, row.mjm_gu, row
                        .mjm_phk, row.mjm_tlo, row.mjm_fire, row.mjm_wp, row.mjm_umut, 0, row
                        .mpras_discrate, row.mjm_wp_pensiun, row.mjm_phk_pensiun, row.mpras_uptambah, row
                        .mpras_ujrah_referal, row.mpras_discrate, row.mpras_mmft_kode_jiwa, row
                        .mssp_tgl_awal, row.mssp_tgl_ahir, row.mssp_komisi, row.mssp_feebase, row
                        .mssp_openpolis, row.mjns_jl, row.mjns_jl_pst, row.mjns_jl_pas);
                    // cekpolis();
                    // ceksoc();
                    // e_leave("mpol_kode");
                    cekdata();
            ...
            selectGrid('mpol_mspaj_nama', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_spaj') }}' +
                '?id=spaj', 'mspaj_nomor', 'mspaj_keterangan', [{
                        field: 'mspaj_keterangan',
                        title: 'Keterangan',
                        align: 'left',
                        width: 150
                    },
            ...
            selectGrid('e_nasabah', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_nasabah') }}', 'mjns_kode',
                'mjns_keterangan', [{
                        field: 'mjns_keterangan',
                        title: 'Jenis Nasabah',
                        align: 'left',
                    ...
                    {
                        field: 'mjns_jl_pst',
                        title: 'Joint Life Peserta',
                        width: 80,
                        hidden: true
                    },
                    {
                        field: 'mjns_jl_pas',
                        title: 'Joint Life Pasangan',
                        width: 80,
                        hidden: true
                    },
                    {
                ...
                function(i, row) {
                    ...
                    reSelGrid('e_jenisprod', '{{ url('tehnik/polis/entry-master-polis/lod_mpid') }}' +
                        '?mjns=' + getText("mpol_mjns_mpid_kode"));
                    cekpolis();
                    muncul3(row.mjns_jl, row.mjns_jl_pst, row.mjns_jl_pas, row.mjns_wp_pens, row.mjns_phk_pens);
                });

            selectGrid('mpol_mssp_nama', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_segmen') }}' +
                '?id=segmen', 'mssp_kode', 'mssp_nama', [{
                        field: 'mssp_kode',
                        title: 'Kode Segmen Pasar',
                        width: 60
                    },
                    {
                        field: 'mssp_nama',
                ...
                function(i, row) {
                    ...
                    muncul2(row.mssp_tgl_awal, row.mssp_tgl_ahir, row.mssp_komisi, row.mssp_feebase, row
                        .mssp_openpolis);
                });

            selectGrid('e_manfaat', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_manfaat') }}', 'mjm_kode',
                'mjm_nama', [{
                        field: 'mjm_nama',
                        title: 'Manfaat',
                        align: 'left',
                ...
                function(i, row) {
                    ...
                    muncul(row.mjm_bundling, row.mjm_jiwa, row.mjm_gu, row.mjm_phk, row.mjm_tlo, row.mjm_fire,
                        row.mjm_wp, row.mjm_umut, row.mjm_wp_pensiun, row.mjm_phk_pensiun);
                    tanya();
                });

            selectGrid('e_jenisprod', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_mpid') }}', 'mpid_kode',
                'mpid_nama', [{
                        field: 'mpid_kode',
                        title: 'Kode',
                        width: 120
            ...
            selectGrid('e_pras', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_pras') }}', 'mpras_kode',
                'mpras_nama', [{
                        field: 'mpras_nama',
                        title: 'Program Asuransi',
                        align: 'left',
                    ...
                    {
                        field: 'mpras_kode',
                        title: 'Kode Program Asuransi',
                        width: 50,
                        hidden: true
                    },
                    {
                        field: 'mpras_uptambah',
                        title: 'UP Tambahan',
                        width: 80,
                        hidden: true
                    },
                    {
                        field: 'mpras_ujrah_referal',
                        title: 'Ujrah Referal',
                        width: 80,
                        hidden: true
                    },
                    {
                        field: 'mpras_disc_rate',
                        title: 'Discount Rate',
                        width: 50,
                        hidden: true
                    },
                    {
                        field: 'mpras_mmft_kode_jiwa',
                        title: 'Tambahan Jiwa',
                        width: 50,
                        hidden: true
                    },
                ...
                function(i, row) {
                    ...
                    muncul1(row.mpras_uptambah, row.mpras_ujrah_referal, row.mpras_discrate, row
                        .mpras_mmft_kode_jiwa);
                    e_leave("mpol_kode");
                });

            selectGrid('e_cabalamin', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_cabalamin_komisi') }}',
                'kode', 'nama', [{
                        field: 'kode',
                        title: 'Kode Cabang',
                        width: 60
                ...
                function(i, row) {
                    ...
                    reSelGrid('e_marketing', '{{ url('api/tehnik/polis/entry-master-polis/lod_marketing') }}' +
                        '?mlok=' + row.kode);
                });

            selectGrid('e_marketing', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_marketing') }}', 'kode',
                'nama', [{
                        field: 'kode',
                        title: 'Kode Cabang',
                        width: 60
            ...
            selectGrid('e_tarif', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_tarif_polis') }}', 'kode',
                'nama', [{
                        field: 'kode',
                        title: 'Kode tarif',
                        width: 75
            ...
            selectGrid('e_uw', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_tarif_polis') }}', 'kode',
                'nama', [{
                        field: 'kode',
                        title: 'Kode Cabang',
                        width: 60
            ...
            tombol('click', 'lihatTarif', function() {
                ...
                if (kode !== "" && kode !== null) {
                    ...
                    setAttr("#tbTarif", "src",
                        "{{ url('tehnik/polis/entry-master-polis/rpt_lihattarif') }}" + "?nomor=" +
                        kode);
                } else {
            ...
            tombol('click', 'lihatUw', function() {
                ...
                if (kode !== "" && kode !== null) {
                    ...
                    setAttr("#tbUw", "src", "{{ url('tehnik/polis/entry-master-polis/rpt_lihat_uw') }}" +
                        "?nomor=" + kode);
                } else {
        ...
        function e_leave(id) {
            ...
            if (id == "mpol_kode") {
                ...
                rms = "&pmgpolis=" + getText("mpol_mrkn_kode") + "&kdstatus=" + getText("endors") + "&mekanisme2=" +
                    getText("mpol_mekanisme2") + "&judul=" + getText("judul") + "&kdsoc=" + getText("mpol_msoc_kode");
                ...
                getJson(url, vv, function(data) {
                    ...
                    if (data) {
                        if (data.mpol_kode != "" && tipe == "0") {
                            cekPesan("info", "Data sudah pernah di input dengan nomor: " + data.mpol_kode, (
                                result) => {
                        ...
                        if (tipe != "0") {
                            ...
                            if (data.mpol_mja_kode == "" || data.mpol_mja_kode == "0" || data.mpol_mgpp_kode ==
                                "" || data.mpol_mgpp_kode == "00") {
                        ...
                        muncul(data.mjm_bundling, data.mjm_jiwa, data.mjm_gu, data.mjm_phk, data.mjm_tlo, data
                            .mjm_fire, data.mjm_wp, data.mjm_umut);
                    }
                });
            }
        }
        ...
        function oldPolis() {
            selectGrid('e_oldpolis', 'GET', '{{ url('tehnik/polis/entry-master-polis/lod_oldpolis') }}', 'mpol_kode',
                'mpol_kode', [{
                        field: 'mpol_kode',
                        title: 'No. Polis',
                        width: 150
        ...
        function cekpolis() {
            ...
            rms = "pmgpolis=" + getText("mpol_mrkn_kode") + "&msoc=" + getText("mpol_msoc_kode") + "&nasabah=" + getText(
                "mpol_mjns_kode") + "&mrkn_nama=" + getText("mpol_mrkn_nama") + "&jns_bayar=" + getText(
                "mpol_jenis_bayar") + "&mekanisme=" + getText("mpol_mekanisme");
        ...
        function ambil_oldpolis(kode) {
            vv = {};
            rms = "pmgpolis=" + getText("mpol_mrkn_kode") + "&mekanisme2=" + getText("mpol_mekanisme2") + "&judul=" +
                getText("judul") + "&nomor=" + kode;
        ...
        function ceksoc() {
            ...
            rms = "pmgpolis=" + getText("mpol_mrkn_kode") + "&mekanisme=" + getText("mpol_mekanisme") + "&msoc=" + getText(
                "mpol_msoc_kode") + "&judul=" + getText("judul") + "&mrkn_nama=" + getText("mpol_mrkn_nama");
        ...
        function cekdata() {
            messageValid(
                'Apakah Anda Yakin data ini sudah sesuai dengan surat penawaran PT Asuransi Jiwa Syariah Al Amin ?', (
                    result) => {
                    if (result.isConfirmed) {
                        cekpolis();
                        ceksoc();
        ...
        function tanya() {
            ...
            setTextReadOnly("mpol_mdr_kode", true);
            messageValid(
                'Silahkan Cek Terlebih Dahulu, Apakah Data Ujroh dan Feebase sudah Benar ( Mengikuti Ketentuan di SOC ) ?',
                (result) => {
                    if (result.isConfirmed) {
        ...
        function muncul4(bandling, mjns_wp_pens, mjns_phk_pens, jiwa, gu, phk, tlo, fire, wp, umut, ujrf, discrate, wp_pens,
            phk_pens, uptambah, ujrah_referal, discrate, mmft_kode_jiwa, mssp_tgl_awal, mssp_tgl_ahir, mssp_komisi,
            mssp_feebase, mssp_openpolis, mjns_jl, mjns_jl_pst, mjns_jl_pas) {
            if (jiwa = "01") {
