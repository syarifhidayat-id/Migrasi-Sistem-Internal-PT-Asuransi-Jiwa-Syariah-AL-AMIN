                                        ...
                                        <div class="mb-5">
                                            <div class="input-group input-group-solid flex-nowrap">
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select class="form-select form-select-solid rounded-0 border-start border-end" data-control="select2" name="mth_kolom" id="mth_kolom" data-placeholder="Pilih" data-allow-clear="true" data-hide-search="true">
                                                        <option></option>
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select class="form-select form-select-solid rounded-0 border-start border-end" data-control="select2" name="mth_baris" id="mth_baris" data-placeholder="Pilih" data-allow-clear="true" data-hide-search="true">
                                                        <option></option>
