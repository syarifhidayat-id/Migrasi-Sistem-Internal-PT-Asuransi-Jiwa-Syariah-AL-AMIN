    ...
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            <div class="modal-header" id="modalLihatUw_header">
                ...
                <button type="button" id="close_btn_uw1" class="btn btn-icon btn-sm btn-active-light-primary" onclick=""><i class="fa-sharp fa-solid fa-xmark"></i></button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" id="close_btn_uw2" class="btn btn-danger btn-sm" onclick=""><i class="fa-solid fa-xmark"></i> Tutup</button>
            </div>
        </div>
    </div>
</div>
