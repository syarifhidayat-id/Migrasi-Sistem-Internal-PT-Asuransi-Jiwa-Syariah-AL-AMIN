<div class="modal fade" id="modalTarif" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            <div class="modal-header" id="modalTarif_header">
                <h2 class="fw-bolder" id="titleTarif"></h2>
            ...
            <form id="frxx_uploadTarif" name="frxx_uploadTarif" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body mx-5">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="modalTarif_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modalTarif_header" data-kt-scroll-wrappers="#modalTarif_scroll" data-kt-scroll-offset="300px">
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <div class="mb-5">
                                    <label class="form-label">Diperuntukan</label>
                                    <select class="form-select form-select-solid" data-control="select2" name="mth_tipe_pertanggungan" id="mth_tipe_pertanggungan" data-dropdown-parent="#modalTarif" data-placeholder="Pilih tipe" data-allow-clear="true">
                                        <option></option>
                            ...
                            <div class="col-md-12">
                                <div class="mb-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-5">
                                                <select class="form-select form-select-solid" data-control="select2" name="mth_tipe_rumus" id="mth_tipe_rumus" data-dropdown-parent="#modalTarif" data-placeholder="Pilih tarif perhitungan" data-allow-clear="true">
                                                    <option></option>
                                            ...
                                            <div class="mb-5">
                                                <div class="input-group input-group-solid flex-nowrap">
                                                    <div class="overflow-hidden flex-grow-1">
                                                        <select class="form-select form-select-solid rounded-0 border-start border-end" name="mth_kolom" id="mth_kolom" data-dropdown-parent="#modalTarif" data-placeholder="Pilih" data-allow-clear="true">
                                                            <option></option>
                                                    ...
                                                    <div class="overflow-hidden flex-grow-1">
                                                        <select class="form-select form-select-solid rounded-0 border-start border-end" name="mth_baris" id="mth_baris" data-dropdown-parent="#modalTarif" data-placeholder="Pilih" data-allow-clear="true">
                                                            <option></option>
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-warning btn-sm" onclick="clearForm('frxx_uploadTarif')"><i class="fa-solid fa-trash"></i> Hapus</button>
