            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="input-group input-group-solid">
                        @if (__getHak('sjab_kode') == 'KDVAKT' ||
                                __getHak('sjab_kode') == 'KDVTEK' ||
                                __getHak('sjab_kode') == 'AKT' ||
                                __getHak('sjab_kode') == 'KBGIT')
                            ...
                            <button type="button" id="btnEds" class="btn btn-light-primary" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-placement="top" title="Tambah Endors"
                                onclick="cekForm(2)">Endors</button>
                            <button type="button" id="btnEdt" class="btn btn-light-primary" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-placement="top" title="Tambah Edit"
                                onclick="cekForm(1)">Edit</button>
                            <button type="button" id="btnBtl" class="btn btn-light-primary" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-placement="top" title="Tambah Batal"
                                onclick="cekForm(3)">Batal</button>
                        @else
                            <button type="button" id="btnBru" class="btn btn-light-primary active"
                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Tambah Baru"
                                onclick="cekForm(0)">Baru</button>
                            <button type="button" id="btnEds" class="btn btn-light-primary" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-placement="top" title="Tambah Endors"
                                onclick="cekForm(2)">Endors</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <input type="text" class="easyui-combogrid" name="msoc_mrkn_nama" id="msoc_mrkn_nama"
                                    data-options="prompt:'Pilih pemegang polis'" style="width: 100%; height: 38px;" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mrkn_kode"
                                    id="msoc_mrkn_kode" placeholder="msoc_mrkn_kode" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="easyui-combogrid" name="e_nasabah" id="e_nasabah"
                                    data-options="prompt:'Pilih nasabah bank'" style="width: 100%; height: 38px;" />
                                <input type="text" class="form-control form-control-solid" name="e_bersih" id="e_bersih"
                                    placeholder="e_bersih" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mjns_kode"
                                    id="msoc_mjns_kode" placeholder="msoc_mjns_kode" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mjns_mpid_kode"
                                    id="msoc_mjns_mpid_kode" placeholder="msoc_mjns_mpid_kode" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="easyui-combobox inputCombo" name="msoc_mssp_nama"
                                    id="msoc_mssp_nama" data-options="prompt:'Pilih segmen pasar'"
                                    style="width: 100%; height: 38px;" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mssp_kode"
                                    id="msoc_mssp_kode" placeholder="msoc_mssp_kode" />
                                <input type="text" class="form-control form-control-solid" name="mpid_mssp_kode"
                                    id="mpid_mssp_kode" placeholder="mpid_mssp_kode" />
                        ...
                        <div class="col-md-8">
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            <input type="text" class="easyui-combogrid" name="msoc_mspaj_nama"
                                                id="msoc_mspaj_nama" data-options="prompt:'Pilih nomor spaj'"
                                                style="width: 100%; height: 38px;" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid"
                                                name="msoc_mspaj_nomor" id="msoc_mspaj_nomor" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_mekanisme" id="msoc_mekanisme"
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_mekanisme2" id="msoc_mekanisme2"
                                    data-options="prompt:'Pilih mekanisme 2'" style="width: 100%; height: 38px;">
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="easyui-combogrid" name="e_manfaat_pol" id="e_manfaat_pol"
                                    data-options="prompt:'Pilih manfaat asuransi'" style="width: 100%; height: 38px;" />
                                <input type="text" class="form-control form-control-solid" name="msoc_approve"
                                    id="msoc_approve" placeholder="msoc_approve" />
                                <input type="text" class="form-control form-control-solid" name="edit_akses"
                                    id="edit_akses" placeholder="edit_akses" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mft_kode"
                                    id="msoc_mft_kode" placeholder="msoc_mft_kode" />
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_jenis_bayar" id="msoc_jenis_bayar"
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_jns_perusahaan" id="msoc_jns_perusahaan"
                                    data-options="prompt:'Pilih jenis pekerjaan', onSelect: function(rec) { cekpolis(); }"
                                    style="width: 100%; height: 38px;">
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_mjm_kode"
                                    id="msoc_mjm_kode" placeholder="msoc_mjm_kode" />
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="mpid_nama"
                                    id="mpid_nama" placeholder="jenis produk" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mpid_kode"
                                    id="msoc_mpid_kode" placeholder="msoc_mpid_kode" />
                        ...
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_mpras_kode"
                                    id="msoc_mpras_kode" placeholder="msoc_mpras_kode" />
                                <label class="required form-label">Urutan Nomor filter/penyaringan harus benar
                                    !</label></br>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_mslr_kode" id="msoc_mslr_kode"
                                    data-options="prompt:'Pilih saluran distribusi', onSelect: function(rec) { cekmanajemenfee(rec.value); }"
                                    style="width: 100%; height: 38px;">
                                ...
                                <input type="text" class="form-control form-control-solid" name="endors"
                                    id="endors" placeholder="endors" />
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <select class="easyui-combobox" name="msoc_mpojk_kode" id="msoc_mpojk_kode"
                                    data-options="prompt:'Pilih produk ojk'" style="width: 100%; height: 38px;">
                                    <option selected disabled>Pilih saluran distribusi</option>
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="easyui-combogrid" name="e_cabalamin" id="e_cabalamin"
                                    data-options="prompt:'Pilih cabang alamin'" style="width: 100%; height: 38px;" />
                                <input type="text" class="form-control form-control-solid" name="msoc_mlok_kode"
                                    id="msoc_mlok_kode" placeholder="msoc_mlok_kode" />
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_mkar_kode_mkr"
                                    id="msoc_mkar_kode_mkr" placeholder="msoc_mkar_kode_mkr" />
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="e_pinca"
                                    id="e_pinca" placeholder="Pimpinan cabang" />
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <select class="easyui-combobox" name="msoc_pajakfee" id="msoc_pajakfee"
                                            data-options="prompt:'Pilih pajak fee'" style="width: 100%; height: 38px;">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_handlingfee" id="msoc_handlingfee"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_handlingfee2" id="msoc_handlingfee2"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                                            {{ optSql('SELECT mmfee_persen persen,mmfee_tampil tampil FROM emst.mst_manajemen_fee ORDER BY 1', 'persen', 'tampil') }}
                                        </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mujh_persen" id="msoc_mujh_persen"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mmfe_persen" id="msoc_mmfe_persen"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                                            {{ optSql('SELECT mmfee_persen persen,mmfee_tampil tampil FROM emst.mst_manajemen_fee ORDER BY 1', 'persen', 'tampil') }}
                                        </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_overreding" id="msoc_overreding"
                                            data-options="prompt:'Pilih overreding'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mkom_persen" id="msoc_mkom_persen"
                                            data-options="prompt:'Pilih', onSelect: function(rec) { cekkom1(rec.value); }"
                                            style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mkomdisc_persen"
                                            id="msoc_mkomdisc_persen"
                                            data-options="prompt:'Pilih', onSelect: function(rec) { cekkom2(rec.value); }"
                                            style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                                            {{ optSql('SELECT mkom_persen persen,mkom_tipe tipe FROM emst.mst_komisi ORDER BY 1', 'persen', 'tipe') }}
                                        </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_referal" id="msoc_referal"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_maintenance" id="msoc_maintenance"
                                            data-options="prompt:'Pilih'" style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                                            {{ optSql('SELECT mdr_persen persen,mdr_tipe tipe FROM emst.mst_discount_rate ORDER BY 1', 'persen', 'tipe') }}
                                        </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mfee_persen" id="msoc_mfee_persen"
                                            data-options="prompt:'Pilih', onSelect: function(rec) { cekdiscrate(rec.value); }"
                                            style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-solid flex-nowrap">
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="easyui-combobox" name="msoc_mdr_kode" id="msoc_mdr_kode"
                                            data-options="prompt:'Pilih', onSelect: function(rec) { cekfeebase(rec.value); }"
                                            style="width: 100%; height: 38px;">
                                            <option selected disabled>Pilih</option>
                                            {{ optSql('SELECT mdr_persen persen,mdr_tipe tipe FROM emst.mst_discount_rate ORDER BY 1', 'persen', 'tipe') }}
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <select class="easyui-combobox" name="msoc_status" id="msoc_status"
                                            data-options="prompt:'Pilih status SOC'" style="width: 100%; height: 38px;">
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_no_endors"
                                    id="msoc_no_endors" placeholder="No surat endors" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <textarea class="form-control form-control-solid" name="msoc_ket_endors" id="msoc_ket_endors" cols="3"
                                    rows="3" placeholder="Keterangan endors"></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_nomor"
                                    id="msoc_nomor" placeholder="Nomor SOC" />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control form-control-solid" name="msoc_kode_x"
                                    id="msoc_kode_x" placeholder="Kode SOC" />
                        ...
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <select class="form-select form-select-solid" data-control="select2"
                                                name="msoc_jenis_tarif" id="msoc_jenis_tarif" data-placeholder="Pilih">
                                                <option selected disabled>Pilih</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <input type="text" class="easyui-combogrid" name="e_tarif" id="e_tarif"
                                                data-options="prompt:'Pilih jenis tarif'"
                                                style="width: 100%; height: 38px;" />
                                            <input type="text" class="form-control form-control-solid"
                                                name="msoc_mth_nomor" id="msoc_mth_nomor" placeholder="msoc_mth_nomor" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <div class="input-group">
                                                <button type="button" id="importTarif"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <select class="form-select form-select-solid" data-control="select2"
                                                name="msoc_tipe_uw" id="msoc_tipe_uw" data-placeholder="Pilih">
                                                <option selected disabled>Pilih</option>
                                                <option value="0">Usia</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <input type="text" class="easyui-combogrid" name="e_uw" id="e_uw"
                                                data-options="prompt:'Pilih jenis underwriting'"
                                                style="width: 100%; height: 38px;" />
                                            <input type="text" class="form-control form-control-solid"
                                                name="msoc_mpuw_nomor" id="msoc_mpuw_nomor"
                                                placeholder="msoc_mpuw_nomor" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-5">
                                            <div class="input-group">
                                                <button type="button" id="importUw"
                                                    class="btn btn-sm btn-light-primary"><i
                                                        class="fa-solid fa-upload"></i> Upload</button>
                        ...
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group input-group-solid">
                                            <input type="file" class="form-control" name="msoc_dok" id="msoc_dok"
                                                accept="application/pdf" placeholder="pilih file" />
                                            <button type="button" id="lihatDocSoc"
                                                class="btn btn-sm btn-light-primary"><i class="fa-solid fa-eye"></i>
                                                Lihat</button>
                                        </div>
    ...
    @section('script')
        <script>
            ...
            $(function() {
                ...
                selectGrid(
                    ...
                    function(i, row) {
                        ...
                        var rms = '&mjns=' + getText("msoc_mjns_kode") + '&mft=' + getText("msoc_mft_kode") +
                            '&mrkn=' + getText("msoc_mrkn_kode") + '&mssp=' + getText("msoc_mssp_kode") + '&mkm=' +
                            getText("msoc_mekanisme") + '&mkm2=' + getText("msoc_mekanisme2") + '&perush=' +
                            getText("msoc_jns_perusahaan") + '&byr=' + getText("msoc_jenis_bayar") + '&mjm=' +
                            getText("msoc_mjm_kode") + '&mpid=' + getText("msoc_mpid_kode");

                        reSelGrid('e_pras', '{{ url('api/tehnik/soc/entry-soc/lod_prassoc') }}' + '?' + rms);
                        reSelGrid('e_manfaat_pol', '{{ url('api/tehnik/soc/entry-soc/select-manasu') }}' + '?' +
                            '&mjns=' + getText("msoc_mjns_kode"));
                    }
                );
                selectBox('msoc_mssp_nama', 'GET', '{{ url('tehnik/soc/entry-soc/grd_segmen') }}', 'value', 'text',
                    function(rec) {
                ...
                selectGrid(
                    ...
                    function(i, row) {
                        ...
                        reSelGrid("e_marketing", '{{ url('api/tehnik/soc/entry-soc/select-marketing') }}' +
                            '?mlok=' + kode);
                    }
                );
                selectGrid(
                    ...
                    [{
                        ...
                        {
                            field: 'skar_overreding',
                            title: 'Tipe Overreding',
                            width: 50,
                            hidden: true
                        },
                    ],
                ...
                tombol('click', 'lihatTarif', function() {
                    ...
                    if (kode !== "" && kode !== null) {
                        ...
                        setAttr("#tbTarif", "src", "{{ url('api/tehnik/soc/entry-soc/rpt_lihattarif') }}" +
                            "?nomor=" + kode);
                    } else {
                ...
                tombol('click', 'lihatUw', function() {
                    ...
                    if (kode !== "" && kode !== null) {
                        ...
                        setAttr("#tbUw", "src", "{{ url('api/tehnik/soc/entry-soc/rpt_lihat_uw') }}" +
                            "?nomor=" + kode);
                    } else {
                ...
                submitImport(
                    ...
                    (res) => {
                        ...
                        setAttr("#showTbTarif", "src", "{{ url('api/tehnik/soc/entry-soc/rpt_lihattarif') }}" +
                            "?nomor=" + kode);
                ...
                submitImport(
                    ...
                    (res) => {
                        ...
                        setAttr("#showTbUw", "src", "{{ url('api/tehnik/soc/entry-soc/rpt_lihat_uw') }}" +
                            "?nomor=" + kode);
            ...
            function setsegmen(rec) {
                ...
                reSelGrid('e_manfaat', '{{ url('api/tehnik/soc/entry-soc/select-jamiasu') }}' + '?' + '&mssp=' + rec.value +
                    '&mjns=' + getText("msoc_mjns_kode"));
            }
            ...
            function cekpolis() {
                ...
                rms = "pmgpolis=" + getText("msoc_mrkn_kode") + "&perus=" + getText("msoc_jns_perusahaan") + "&mekanisme2=" +
                    getText("msoc_mekanisme2") + "&mekanisme=" + getText("msoc_mekanisme") + "&jns_bayar=" + getText(
                        "msoc_jenis_bayar") + "&nasabah=" + getText("msoc_mjns_kode") + "&mrkn_nama=" + getText(
                        "msoc_mrkn_nama") + "&mft=" + getText("msoc_mft_kode");
            ...
            function e_leave(id) {
                ...
                if (id == 'msoc_kode') {
                    ...
                    rms = '&pmgpolis=' + getText('msoc_mrkn_kode') + '&nopolis=' + getText('msoc_nomor') + '&nasabah=' +
                        getText('msoc_mjns_kode') + '&mft=' + getText('msoc_mft_kode') + '&mjm=' + getText('msoc_mjm_kode') +
                        '&mekanisme=' + getText('msoc_mekanisme') + '&jns_bayar=' + getText('msoc_jenis_bayar') +
                        '&jns_perusahaan=' + getText('msoc_jns_perusahaan') + '&mrkn_nama=' + getText('msoc_mrkn_nama') +
                        '&mekanisme2=' + getText('msoc_mekanisme2') + '&kode=' + getText('msoc_kode') + '&pras=' + getText(
                            'msoc_mpras_kode') + '&endos=' + getText('endors');
            ...
            function tanya() {
                if (getText('e_pras') == '1') {
                    ...
                    messageValid(
                        'APAKAH ANDA YAKIN PROGRAM ASURANSI INI ADALAH PROGRAM YANG TIDAK MEMBERIKAN KOMISI KEPADA PEMEGANG POLIS ?',
                        (result) => {
                            if (result.isConfirmed) {
                                setTextReadOnly('e_pras', true);
                ...
                if (getText('e_pras') == '2') {
                    ...
                    setTextReadOnly('e_manfaat', true);
                    setTextReadOnly('msoc_mssp_nama', true);
                    messageValid('APAKAH ANDA YAKIN PROGRAM ASURANSI INI MEMBERIKAN KOMISI KEPADA PEMEGANG POLIS ?', (
                        result) => {
                        if (result.isConfirmed) {
                            setTextReadOnly('e_pras', true);
                        } else if (result.isDenied) {
                ...
                if (getText('e_pras') == '3') {
                    ...
                    setTextReadOnly('msoc_mssp_nama', true);
                    messageValid(
                        'APAKAH ANDA YAKIN PROGRAM ASURANSI INI MEMBERIKAN MANFAAT TAMBAHAN UANG PERTANGGUNGAN DAN KOMISI KEPADA PEMEGANG POLIS ?',
                        (result) => {
                            if (result.isConfirmed) {
                                setTextReadOnly('e_pras', true);
                            } else if (result.isDenied) {
                ...
                if (getText('e_pras') == '4') {
                    ...
                    setTextReadOnly('msoc_mssp_nama', true);
                    messageValid(
                        'APAKAH ANDA YAKIN PROGRAM ASURANSI INI HANYA MEMBERIKAN MANFAAT TAMBAHAN UANG PERTANGGUNGAN KEPADA PEMEGANG POLIS ?',
                        (result) => {
                            if (result.isConfirmed) {
                                setTextReadOnly('e_pras', true);
                            } else if (result.isDenied) {
