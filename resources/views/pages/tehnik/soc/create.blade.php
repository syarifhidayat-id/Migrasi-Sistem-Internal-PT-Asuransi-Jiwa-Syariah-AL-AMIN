            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control form-control-solid" name="msoc_mrkn_kode" id="msoc_mrkn_kode" placeholder="msoc_mrkn_kode" hidden />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-5">
                        ...
                        <span class="text-danger error-text msoc_mlok_kode_err"></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-5">
