<div class="modal fade" id="modalUwKhusus" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            <div class="modal-header" id="modalUwKhusus_header">
            ...
            <form id="frxx_uiuKhusus" name="frxx_uiuKhusus" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" name="mpuw_tipe_pertanggungan" id="mpuw_tipe_pertanggungan" data-dropdown-parent="#modalUwKhusus" data-placeholder="Pilih diperuntukan" data-allow-clear="true">
                                    <option></option>
                        ...
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-5">
                                            <select class="form-select form-select-solid" data-control="select2" name="mpuw_type_uw" id="mpuw_type_uw" data-dropdown-parent="#modalUwKhusus" data-placeholder="Pilih tipe UW" data-allow-clear="true">
                                                <option></option>
                                        ...
                                        <div class="mb-5">
                                            <div class="input-group input-group-solid flex-nowrap">
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select class="form-select form-select-solid" name="mpuw_baris" id="mpuw_baris" data-dropdown-parent="#modalUwKhusus" data-placeholder="Pilih jumlah" data-allow-clear="true">
                                                        <option></option>
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" id="btn_uiuKhusus_simpan"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
