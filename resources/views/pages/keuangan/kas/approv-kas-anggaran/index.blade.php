                        ...
                        <div class="scroll h-400px px-5">
                            <div class="px-7 py-5" data-kt-datatable-table-filter="form" >
                                <div class="row mb-10">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="input-group input-group-solid flex-nowrap">
                                                    <div class="overflow-hidden flex-grow-1">
                                                            ...
                                                            data-kt-select2="true" data-placeholder="Bulan"
                                                            data-allow-clear="true" data-kt-datatable-table-filter="e_entry1"
                                                            data-hide-search="false" id="e_entry1" name="e_entry1">
                                                            <option></option>
                                                        </select>
                                                    </div>
                                                    <span class="input-group-text px-auto">s.d</span>
                                                    <div class="overflow-hidden flex-grow-1">
                                                            <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                            data-kt-select2="true" data-placeholder="Bulan"
                                                            data-allow-clear="true" data-kt-datatable-table-filter="e_entry2"
                                                            data-hide-search="false" id="e_entry2" name="e_entry2">
                                                            <option></option>
                                                        </select>
                                                    </div>
                                                    {{-- <div class="overflow-hidden flex-grow-1">
                                                            <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                            data-kt-select2="true" data-placeholder="Tahun"
                                                            data-allow-clear="true" data-kt-datatable-table-filter="tahun"
                                                            data-hide-search="false" id="tahun" name="tahun">
                                                            <option></option>
                                                        </select>
                                                    </div> --}}
                                                </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-5">
                                            <label class="form-label fs-6 fw-bold">&nbsp;</label>
                                            <div class="d-flex flex-stack">
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Tahun"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="e_tahun"
                                                    data-hide-search="false" id="e_tahun" name="e_tahun">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Pilih cabang"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="nama-cabang"
                                                    data-hide-search="false" id="e_cabalaminx" name="e_cabalaminx">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    ...
                                                    data-allow-clear="true" data-kt-datatable-table-filter="nama-buku"
                                                    data-hide-search="false" id="e_keu2" name="e_keu2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Pilih proses"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="e_pms"
                                                    data-hide-search="false" id="e_pms" name="e_pms">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Pilih proses"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="e_keu1"
                                                    data-hide-search="false" id="e_keu1" name="e_keu1">
                                                    <option value="0" selected>Belum Approv</option>
                                                    <option value="1">Setuju</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Pilih proses"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="e_acc"
                                                    data-hide-search="false" id="e_acc" name="e_acc">
                                                    <option value="0" selected>Belum Approv</option>
                                                    <option value="1">Setuju</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <select class="form-select form-select-solid fw-bolder" data-control="select2"
                                                    data-kt-select2="true" data-placeholder="Pilih proses"
                                                    data-allow-clear="true" data-kt-datatable-table-filter="e_group"
                                                    data-hide-search="false" id="e_group" name="e_group">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            selectSide('e_cabalaminx', false, '{{ url('api/keuangan/kas/approv-kas-anggaran/cabang_alamin') }}',
                ...
                selectSide('e_entry1', false, '{{url('api/bulan')}}',
                function(d){
                    return {
                        id: d.no,
                        text: d.nama
                ...
                [ //fillable body table name, sesuaikan dengan field yang terdapat pada tr thead
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<button type="button" onclick="approv_rk('`+ row.tkad_pk + `','0')" class="btn btn-light-success">`+ row.tkad_keterangan +`</button>`;
                        }
                    },
                    {
                        data: 'debit',
                    ...
                    },
                    {
                        ...
                        // className: 'text-left',
                        render: function(data, type, row) {
                            return `<button type="button" onclick="cetakpstaju('`+ row.tdna_kode_vcr + `','0')" class="btn btn-light-success">`+ row.tdna_kode_vcr +`</button>`;
                        }
                    },
                    {
                        data: null,
                        ...
                        // className: 'text-left',
                        render: function(data, type, row) {
                            return `<button type="button" onclick="showPil('`+ row.tdna_pk +`')" class="btn btn-light-success">Lihat</button>`;
                        }
                    },
                    {
                        data: 'mta_keterangan',
