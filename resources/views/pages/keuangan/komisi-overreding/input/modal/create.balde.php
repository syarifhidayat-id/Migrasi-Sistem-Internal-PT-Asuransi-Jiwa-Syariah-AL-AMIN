                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid required_sel" name="wmn_tipe" id="wmn_tipe" data-dropdown-parent="#modalInputTax" data-placeholder="Pilih tipe menu" data-allow-clear="true">
                                        <option></option>
                                    </select>
                            ...
                            <div class="col-md-6 mb-5">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid required_sel" name="wmn_key" id="wmn_key" data-dropdown-parent="#modalInputTax" data-placeholder="ex. MAIN" data-allow-clear="true">
                                        {{-- <option></option> --}}
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" name="wmn_mrkn_kode" id="wmn_mrkn_kode" data-dropdown-parent="#modalInputTax" data-placeholder="pilih Pemegang Polis" data-allow-clear="true">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select class="form-select form-select-solid" name="wmn_mpol_kode" id="wmn_mpol_kode" data-dropdown-parent="#modalInputTax" data-placeholder="pilih Nomor Polis" data-allow-clear="true">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
