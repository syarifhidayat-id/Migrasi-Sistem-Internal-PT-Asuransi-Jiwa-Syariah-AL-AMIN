...
use App\Http\Controllers\Tehnik\polis\LihatPolisController;
...
Route::group(['prefix' => '/tehnik', 'as' => 'tehnik.'], function () {
    ...
    Route::group(['prefix' => '/soc', 'as' => 'soc.'], function () {
        ...
        Route::group(['prefix' => '/soc-terbit-polis', 'as' => 'soc-terbit-polis.'], function () {
            Route::resource('/', SocTerbitPolisController::class);
        });
    ...
    Route::group(['prefix' => '/polis', 'as' => 'polis.'], function () {
        ...
        Route::group(['prefix' => 'lihat-polis', 'as' => 'lihat-polis.'], function () {
            ...
            Route::get('grd_lihat_polis', [Grd::class, 'grd_lihat_polis']);
            Route::get('lod_pmg_polis', [Lod::class, 'lod_pmg_polis']);

            Route::get('get_polisfull2', [Get::class, 'get_polisfull2']);
            Route::get('lod_segmen', [Lod::class, 'lod_segmen']);
            Route::get('get_kodepoliskodeapprov', [Get::class, 'get_kodepoliskodeapprov']);
        });
