...
function selectServerSide(kode, url, data) {
    $('#' + kode).select2({
        ajax: {
            url: url,
            dataType: 'json',
...
function selectServerSideReq(kode, url, data) {
    $('#' + kode).addClass('required_sel');
    $('#' + kode).select2({
        ajax: {
            url: url,
...
function selectServerSideReq2(kode, url, data) {
    $('#' + kode).addClass('required_sel');
    $('#' + kode).select2({
        ajax: {
            url: url,
...
//     return data.mjns_keterangan;
// }

// function getReq2(data)

function changeSelect(id_get, id_val, url, data) {
