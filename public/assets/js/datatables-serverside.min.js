function serverSide(kodeTable, urlAjax, dFilter, dataKolom, dataFoot, drawCel) {
    ...
    var KTDatatablesButtons = function() {
        ...
        var initDatatable = function() {
            ...
            datatable = $(table).DataTable({
                ...
                columns: dataKolom,
                language: {
                    url: $(location).attr('origin') + "/assets/js/language.json"
                },
                footerCallback: dataFoot,
                drawCallback: drawCel,
                // responsive: {
                //     details: {
        ...
        var handleSearchDatatable = () => {
            const filterSearch = document.querySelector('[data-kt-datatable-table-filter="search"]'),
                ...
                checkBox = formOption.querySelectorAll('[data-checkbox]'),
                kodeCheck = document.querySelectorAll('[data-kt-datatable-table-filter="form"] [data-checkbox]'),
                cariAll = () => {
                    if(filterOp) {
            ...
            cariAll();
            kodeCheck.forEach(changeCheck => {
                changeCheck.addEventListener('change', e => {
                    e.preventDefault();
                    const kode = e.target.getAttribute('data-checkbox');
                    $('#' + kode).on('change', function() {
                        this.value = this.checked ? 1 : 0;
                    }).change();
                    $('#' + kode).on(':checked').each(function() {
                        cariAll();
                    });
                });
            });
