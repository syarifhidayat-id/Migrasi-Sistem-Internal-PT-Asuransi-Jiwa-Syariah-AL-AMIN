function serverSide(kodeTable, urlAjax, dFilter, dataKolom) {
    ...
    var KTDatatablesButtons = function() {
        ...
        var handleSearchDatatable = () => {
            ...
            // const kodeCheck = document.querySelectorAll('[data-kt-datatable-table-filter="form"] [data-checkbox]');
            ...
            //         const valueCk = $('#' + kode).val();
            //         const selectCk = $('#' + kode).on(':checked');
            //         const cked = selectCk[0].checked;
            //         // console.log(valueCk);
            //         // console.log(cked);
            //         if (valueCk == 1 && cked == true) {
            //             filterOp.addEventListener('click', (function() {
            //                 var formOption = "";
            //                 // checkBox.forEach(((frxx, filterOp) => {
            //                 //     {
            ...
            filterOp.addEventListener('click', (function(e) {
                var formOption = "";
                // checkBox.forEach(((frxx, filterOp) => {
                //     {
                //         frxx.value && "" !== frxx.value && (0 !== filterOp && (formOption += " "), formOption += frxx.value);
