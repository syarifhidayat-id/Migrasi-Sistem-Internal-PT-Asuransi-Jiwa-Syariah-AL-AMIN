function serverSide(idTable, urlAjax, dataKolom) {
    "use strict";
    ...
    var KTDatatablesButtons = function () {
        ...
        var handleSearchDatatable = () => {
            ...
            filterSearch.addEventListener('keyup', function (frxx) {
                datatable.search(frxx.target.value).draw();
            });
        ...
        return {
            init: function () {
                table = document.querySelector(idTable);
